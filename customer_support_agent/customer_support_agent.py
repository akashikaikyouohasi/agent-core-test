...
顧客からメールが提供された場合、必要な情報を全て収集し、返信メールを準備してください。
...
@tool
def get_knowledge_base_inf(topic: str):
...
agent = Agent(
    ...
    tools=[get_customer_id, get_orders, get_knowledge_base_inf, calculator, current_time]
)
